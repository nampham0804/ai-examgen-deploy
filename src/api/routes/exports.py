...
def is_correct_match(opt: str, ans: str, index: int = -1) -> bool:
    ...
    if o_clean == a_clean: return True
    return False
...
"""
    ...
    for i, q in enumerate(preview_data.questions):
        ...
        if q.type in ['Multiple Choice', 'mcq']:
            ...
            xml_content += f'    <idnumber></idnumber>\n'
            ...
            xml_content += f'    <showstandardinstruction>0</showstandardinstruction>\n'
...
def export_doc(exam_id: int, db: Session = Depends(get_db)):
    ...
    try:
        ...
        html_content = f"""<html xmlns="http://www.w3.org/1999/xhtml" lang="VI" dir="ltr">
...
<body lang="EN-UK" style="tab-interval:36.0pt"><container>"""
    ...
    for i, q in enumerate(preview_data.questions):
        ...
        html_content += f'<table border="1" dir="ltr"><thead>\n'
